...
1. ¿En qué consiste el principio de responsabilidad única? ¿Cuál es su propósito? 
 - Este principio se basa basicamente que un objeto o funcion debe hacer una unica cosa eso con el proposito de separa responsabilidades y tener un orden en que hace cada cosa. 
2. ¿Qué características tiene, según su opinión, un “buen” código o código limpio? 
 - En mi concepto un bueno codigo o codigo limpio es aquel que habla por si solo, es entendible, escalable y perdura en el tiempo
3. Detalla cómo harías todo aquello que no hayas llegado a completar. 
 - No agregue muchas animaciones como lo esperaba, tal vez haria algo con MotionLayout en el detalle de la pelicula cuando se muestra o aun mejor, usuaria JetpackCompose para gestionar estas animaciones en este modulo de la app. 
